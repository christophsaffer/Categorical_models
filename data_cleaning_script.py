...
#new1 = ['low', 'rich', 'west', 'male', 'middle', 'low', 'right party']

#cleaned_data.loc[0] = new1
...
#            return 'NIEDRIG'
    ...
    if j == 5:
        ...
        if entry in ['WENIG', 'UEBERHAUPT NICHT']:
            return 'NEIN'
    if j == 6:
        if entry in ['NICHT WAHLBERECHTIGT', 'DATENFEHLER', 'KEINE ANGABE', 'WEISS NICHT', 'VERWEIGERT', 'ANDERE PARTEI', 'PIRATEN']:
            return 0
        else:
            return entry
